...
description: XBRL 到 SEC html 报告 Python 转换的示例代码。在基于 Python 的应用程序中使用 API 示例代码将批处理 XBRL 文件转换为 SEC html 报告转换。 
url: /zh/python-net/conversion/xbrl-to-sec-html-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Python 将 XBRL 转换为 SEC html 报告" h2="XBRL 到 SEC html 报告转换，无需在基于 .NET 的应用程序中使用任何其他软件。" >}}
...
1. 使用 XbrlDocument 类加载输入 XBRL 文件。2. 通过选择 SaveFormat.SEC_HTML_REPORT 为输出文件设置 SaveOptions。
3.通过提供目标文件和相关的SaveOptions作为参数来调用save方法。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="转换要求" %}}
要继续将 XBRL 转换为 SEC html 报告，请确保您具有以下先决条件。 
