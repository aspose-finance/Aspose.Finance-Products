---
title: Python 财务数字报告系统 API - Aspose 
weight: 20
url: /zh/python-net/ 
description: Python 将财务报表转换为可扩展业务报告语言的库 XBRL 和 iXBRL 以进行分析以生成 XBRL 分类法和报告
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python 用于解析 Finance 文档的库" h2="在任何业务流程管理、财务分析和报告软件中创建、阅读和验证 XBRL 和 iXBRL Finance 相关格式。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/finance/headers/aspose_finance-for-python-net.svg" pfName="Aspose.Finance " subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/finance/python-net" >}}
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="通过 .NET API 对 Python 的 Aspose.Finance 进行概述。" >}}
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Finance for Python 通过 .NET 支持所有主要平台，包括。" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Python 通过 .NET 的 Aspose.Finance 支持与金融相关的格式。" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    高级 Python 通过 .NET Finance 解析 API 功能
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for Python via .NET 支持生成 XBRL 文档。只需以下几行代码即可创建一个新的 XBRL 实例文档
    </p>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/finance/python-net/" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-finance/Aspose.Finance-for-Python-via-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么通过 .NET 为 Python 提供 Aspose.Finance？" tabId="success-stories" >}}
