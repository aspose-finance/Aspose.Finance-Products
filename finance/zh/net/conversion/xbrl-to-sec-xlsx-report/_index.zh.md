...
description: XBRL 到 SEC xlsx 报告 C# 转换的示例代码。在基于 .NET 的应用程序中使用 API 示例代码将批处理 XBRL 文件转换为 SEC xlsx 报告转换。 
url: /zh/net/conversion/xbrl-to-sec-xlsx-report/
family: finance
platformtag: net
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 XBRL 转换为 SEC xlsx 报告" h2="XBRL 到 SEC xlsx 报告转换，无需在基于 .NET 的应用程序中使用任何其他软件。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何将 XBRL 转换为 SEC xlsx 报告" %}}
1. 使用加载输入 XBRL 文件 [XbrlDocument 类](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/xbrldocument).2.设置 [保存选项](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/saveoptions) 通过选择输出文件 [SaveFormat.SEC_XLSX_REPORT](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/saveformat).
...
要进行 XBRL 到 SEC xlsx 报告的转换，.NET Finance API 是主要要求。通过命令行将其安装为 ```nuget install Aspose.Finance``` 或通过 Visual Studio 的包管理器控制台使用 ```Install-Package Aspose.Finance``` 进行安装。

或者，从 ZIP 文件中获取离线 MSI 安装程序或 DLL [下载](https://downloads.aspose.com/finance/net).
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="将 XBRL 转换为 SEC xlsx 报告文件的 C# 源代码" offSpacer="" %}}
