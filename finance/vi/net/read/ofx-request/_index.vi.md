---
title: Đọc OFX Tệp yêu cầu qua C#
description: Mã mẫu để đọc tệp yêu cầu OFX. Sử dụng mã mẫu API để đọc hàng loạt OFX tệp yêu cầu trong các ứng dụng dựa trên .NET. 
url: /vi/net/read/ofx-request/
family: finance
platformtag: net
feature: read
...
{{< blocks/products/pf/i18n/feature-page-header h1="Đọc OFX yêu cầu Tệp qua C#" h2="Đọc báo cáo tài chính ở định dạng OFX yêu cầu mà không cần cài đặt Microsoft Office hoặc bất kỳ phần mềm nào khác." >}}
...
{{% blocks/products/pf/agp/code-block title="C# mã để đọc OFX tệp yêu cầu" offSpacer="" %}}
