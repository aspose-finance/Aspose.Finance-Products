---
title: Chuyển đổi OFX Tệp Yêu cầu từ Định dạng 1.03 sang 2.2 qua C#
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi OFX Tệp Yêu cầu từ Định dạng 1.03 sang 2.2 qua C#" h2="OFX Yêu cầu tệp chuyển đổi từ 1.03 sang 2.2 mà không cần cài đặt Microsoft Office." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi OFX tệp yêu cầu từ định dạng 1.03 sang 2.2" %}}
1. Tải tệp đầu vào bằng cách sử dụng [Lớp OfxRequestDocument](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument).1. Sử dụng ofxVersion V2x từ [OfxVersionEnum](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxversionenum) dưới dạng tham số trong phương thức Lưu.1. Gọi [Lưu phương pháp](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument/methods/save) bằng cách cung cấp tệp đích và ofxVersion.
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Yêu cầu chuyển đổi" %}}
Để tiến hành chuyển đổi OFX Tệp Yêu cầu từ 1.03 sang 2.2, .NET Finance API là yêu cầu chính. 
...
{{% blocks/products/pf/agp/code-block title="C# mã cho OFX tệp yêu cầu chuyển đổi định dạng từ 1.03 sang 2.2" offSpacer="" %}}
