...
description: Mã mẫu cho chuyển đổi từ XBRL báo cáo xlsx sang SEC C#. Sử dụng API mã ví dụ cho hàng loạt tệp XBRL để chuyển đổi báo cáo xlsx SEC trong các ứng dụng dựa trên .NET. 
url: /vi/net/conversion/xbrl-to-sec-xlsx-report/
family: finance
platformtag: net
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi XBRL sang báo cáo xlsx SEC qua C#" h2="Chuyển đổi báo cáo XBRL sang SEC xlsx mà không cần bất kỳ phần mềm nào khác trong các ứng dụng dựa trên .NET." >}}
...
1. Tải tệp XBRL đầu vào bằng [Lớp XbrlDocument](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/xbrldocument).2 bộ [Lưu tùy chọn](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/saveoptions) cho tệp đầu ra bằng cách chọn [SaveFormat.SEC_XLSX_REPORT](https://apireference.aspose.com/finance/net/aspose.finance.xbrl/saveformat).
...
Để tiếp tục chuyển đổi báo cáo xlsx từ XBRL sang SEC, .NET Finance API là yêu cầu chính. Cài đặt nó thông qua dòng lệnh là `` nuget install Aspose.Finance '' hoặc thông qua Package Manager Console của Visual Studio với `` Install-Package Aspose.Finance ''.
