...
Để tiến hành chuyển đổi iXBRL sang XBRL, .NET Finance API là yêu cầu chính. Cài đặt nó thông qua dòng lệnh là `` nuget install Aspose.Finance '' hoặc thông qua Bảng điều khiển Trình quản lý Gói của Visual Studio với `` Cài đặt Gói Aspose.Finance ''.
