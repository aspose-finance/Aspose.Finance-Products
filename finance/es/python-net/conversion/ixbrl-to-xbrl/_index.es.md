---
title: Convertir XBRL a iXBRL(xbrl en línea) a través de Python
description: Ejemplo de código para la conversión de iXBRL a XBRL Python. Utilice el código de ejemplo API para la conversión por lotes de archivos iXBRL a XBRL dentro de las aplicaciones basadas en Python. 
url: /es/python-net/conversion/ixbrl-to-xbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir iXBRL(xbrl en línea) a XBRL a través de Python" h2="Conversión de iXBRL a XBRL sin necesidad de ningún otro software dentro de las aplicaciones basadas en Python." >}}
...
1. Cargue el archivo XBRL en línea de entrada usando la clase InlineXbrlDocument.2. Llame al método export_to_xbrl proporcionando el archivo de destino como parámetros.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}
Para continuar con la conversión de iXBRL a XBRL, asegúrese de cumplir los siguientes requisitos previos. 
