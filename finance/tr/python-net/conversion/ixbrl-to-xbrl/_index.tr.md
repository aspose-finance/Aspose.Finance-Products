---
title: XBRL'i Python aracılığıyla iXBRL(satır içi xbrl) biçimine dönüştürün
description: iXBRL - XBRL Python dönüşümü için örnek kod. Python tabanlı uygulamalarda toplu iXBRL dosyaları XBRL dönüştürme için API örnek kodunu kullanın. 
url: /tr/python-net/conversion/ixbrl-to-xbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="iXBRL(inline xbrl) öğesini Python aracılığıyla XBRL biçimine dönüştürün" h2="Python tabanlı uygulamalarda başka bir yazılıma ihtiyaç duymadan iXBRL\'den XBRL\'ye dönüşüm." >}}
...
1. InlineXbrlDocument sınıfını kullanarak giriş satır içi XBRL dosyasını yükleyin.2. Hedef dosyayı parametre olarak sağlayarak export_to_xbrl yöntemini çağırın.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Dönüşüm Gereksinimleri" %}}
iXBRL - XBRL dönüşümüne devam etmek için aşağıdaki ön koşullara sahip olduğunuzdan emin olun. 
