---
title: XBRL Dosyayı Python aracılığıyla okuyun
description: XBRL dosya okuması için örnek kod. Python tabanlı uygulamalarda toplu XBRL dosyalarını okumak için API örnek kodunu kullanın. 
url: /tr/python-net/read/xbrl/
family: finance
platformtag: python
feature: read
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Python üzerinden XBRL Dosyaları Okuyun" h2="Microsoft Office yüklü veya başka bir yazılıma ihtiyaç duymadan finansal raporları XBRL formatında okuma." >}}
...
1. XbrlDocument sınıfı Örneği oluşturun.1. Geçerli bir XBRL dosyasının adını parametre olarak iletin.1. Dosyanın iç detayını almak için SchemaRefCollection, Context, Unit gibi ilgili sınıfları kullanın.
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Okuma Gereksinimi" %}}
XBRL dokümanı okumaya devam etmek için aşağıdaki ön koşullara sahip olduğunuzdan emin olun. 
