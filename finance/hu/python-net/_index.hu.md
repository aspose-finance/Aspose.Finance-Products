---
title: Python API-k pénzügyi digitális jelentési rendszerekhez – Aspose 
weight: 20
url: /hu/python-net/ 
description: Python könyvtár a pénzügyi kimutatások eXtensible Business Reporting Language XBRL nyelvre való konvertálásához és iXBRL a XBRL taxonómiák és jelentések létrehozásához szükséges elemzésekhez
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python Könyvtár a Finance dokumentumok elemzéséhez" h2="Hozzon létre, olvasson és érvényesítsen XBRL és iXBRL Finance-kapcsolódó formátumokat bármely üzleti folyamatkezelő, pénzügyi elemző és jelentéskészítő szoftveren belül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/finance/headers/aspose_finance-for-python-net.svg" pfName="Aspose.Finance " subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/finance/python-net" >}}
...
<p align="justify"> A(z) Aspose.Finance for Python, via .NET egy rugalmas könyvtár a pénzügyekkel kapcsolatos formátumok feldolgozásához. A API könnyedén létrehozhat, elolvashat és ellenőrizhet eXtensible Business Reporting Language XBRL és iXBRL formátumokat, valamint OFX kérés- és válaszfájlokat hozhat létre különböző formátumokban. A fejlesztők könnyedén fejleszthetnek XBRL-kompatibilis szoftvereket, vagy bármely meglévő digitális pénzügyi jelentési rendszeren belül használhatják jelentéseket a XBRL segítségével. Ez egy bővíthető, könnyen használható és önálló API, amely minden más szoftvertől független.</p>
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="A(z) Aspose.Finance áttekintése a(z) Python számára a következőn keresztül: .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="A(z) Aspose.Finance for Python a(z) .NET-on keresztül támogatja az összes főbb platformot, beleértve." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="A(z) Aspose.Finance for Python a(z) .NET-on keresztül támogatja a pénzügyekkel kapcsolatos formátumokat." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Speciális Python a .NET Finance Elemző API funkción keresztül
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     A(z) Aspose.Finance for Python a(z) .NET szolgáltatáson keresztül támogatja a(z) XBRL dokumentum generálását. A következő néhány sornyi kóddal új XBRL példánydokumentumot hozhat létre
    </p>
    <div class="codeblock" id="code">
     <h3>
      XBRL példány létrehozása - Python
     </h3>
{{< gist "aspose-finance-gists" "e1df624c58dc6f522a87f29ceb041dd9" "create-xbrl-instance.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      iXBRL példány dokumentum olvasása - Python
     </h3>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/finance/python-net/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-finance/Aspose.Finance-for-Python-via-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért Aspose.Finance a(z) Python számára a következőn keresztül: .NET?" tabId="success-stories" >}}
