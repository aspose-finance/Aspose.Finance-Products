---
title: API mondiales de création de rapports financiers numériques – Aspose 
weight: 10
url: /fr/family
description: Bibliothèque pour manipuler les formats liés aux finances utilisés dans le dépôt des entreprises et générer des rapports pour les fonds et les effets de levier sur n'importe quelle plate-forme
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API pour traiter les formats XBRL, iXBRL" h2="API natives .NET pour manipuler des formats liés aux finances tels que XBRL, iXBRL sans aucune dépendance logicielle." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/finance/aspose_finance.svg" pfName="Aspose.Finance" downloadUrl="https://downloads.aspose.com/finance" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-finance" >}}
{{< blocks/products/pf/slr-element name="API références" href="https://apireference.aspose.com/finance" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Finance famille de produits ?" tabId="success-stories" >}}
