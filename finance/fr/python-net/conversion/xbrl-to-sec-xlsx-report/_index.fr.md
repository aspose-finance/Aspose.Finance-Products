...
description: Exemple de code pour la conversion XBRL en rapport SEC xlsx Python. Utilisez l'exemple de code API pour les fichiers batch XBRL vers la conversion de rapport SEC xlsx dans les applications basées sur Python. 
url: /fr/python-net/conversion/xbrl-to-sec-xlsx-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir XBRL en rapport SEC xlsx via Python" h2="Conversion de rapport XBRL en SEC xlsx sans avoir besoin d\'aucun autre logiciel dans les applications basées sur Python." >}}
...
1. Chargez le fichier d'entrée XBRL à l'aide de la classe XbrlDocument.2. Définissez SaveOptions pour le fichier de sortie en choisissant SaveFormat.SEC_XLSX_REPORT.
...
Pour procéder à la conversion du rapport XBRL en SEC xlsx, assurez-vous que vous disposez des prérequis suivants. 
