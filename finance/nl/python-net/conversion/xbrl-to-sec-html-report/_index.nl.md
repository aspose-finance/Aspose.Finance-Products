---
title: Converteer XBRL naar iXBRL via Python
description: Voorbeeldcode voor conversie van XBRL naar SEC html-rapport Python. Gebruik API voorbeeldcode voor batch XBRL-bestanden naar SEC html-rapportconversie binnen Python-gebaseerde applicaties. 
url: /nl/python-net/conversion/xbrl-to-sec-html-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer XBRL naar SEC html-rapport via Python" h2="XBRL naar SEC html-rapportconversie zonder dat er andere software nodig is binnen op .NET gebaseerde applicaties." >}}
...
1. Laad invoer XBRL-bestand met de XbrlDocument-klasse.2. Stel SaveOptions in voor het uitvoerbestand door SaveFormat.SEC_HTML_REPORT te kiezen.
3. Roep de opslagmethode aan door het doelbestand en relevante SaveOptions als parameters op te geven.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Conversievereisten" %}}
Om door te gaan voor XBRL naar SEC html-rapportconversie, moet u aan de volgende vereisten voldoen. 
