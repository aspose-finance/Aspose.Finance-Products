---
title: Python APIs for Financial Digital Reporting Systems - Aspose 
weight: 20
url: /python-net/ 
description: Python library for conversion of financial statements to eXtensible Business Reporting Language XBRL and iXBRL for analysis to generate XBRL taxonomies and reports
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Python Library to Parse Finance Documents" h2="Create, Read and Validate XBRL and iXBRL Finance-Related Formats within any Business Processes Management, Financial Analysis and Reporting Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/finance/headers/aspose_finance-for-python-net.svg" pfName="Aspose.Finance " subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/finance/python-net" >}}
...
{{< blocks/products/pf/carousel-item h3="At a Glance" description="An overview of Aspose.Finance for Python via .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.Finance for Python via .NET supports all major platforms including." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.Finance for Python via .NET supports finance-related formats." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced Python via .NET Finance Parsing API Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for Python via .NET supports generating XBRL documents. With the following just few lines of code to create a new XBRL instance document
    </p>
    <div class="codeblock" id="code">
     <h3>
      Create XBRL Instance - Python
     </h3>
{{< gist "aspose-finance-gists" "e1df624c58dc6f522a87f29ceb041dd9" "create-xbrl-instance.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Read iXBRL instance documents - Python
     </h3>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-finance/Aspose.Finance-for-Python-via-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Finance for Python via .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/finance/python-net" pricingInformationLink="https://purchase.aspose.com/pricing/finance/python-net" >}}
