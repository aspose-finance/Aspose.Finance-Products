...
要進行 XBRL 到 SEC xlsx 報告的轉換，.NET Finance API 是主要要求。通過命令行將其安裝為 ```nuget install Aspose.Finance``` 或通過 Visual Studio 的包管理器控制台使用 ``Install-Package Aspose.Finance``` 安裝。
