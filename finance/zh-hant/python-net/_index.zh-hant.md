---
title: Python 財務數字報告系統 API - Aspose 
weight: 20
url: /zh-hant/python-net/ 
description: Python 將財務報表轉換為可擴展業務報告語言的庫 XBRL 和 iXBRL 以進行分析以生成 XBRL 分類法和報告
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python 用於解析 Finance 文檔的庫" h2="在任何業務流程管理、財務分析和報告軟件中創建、閱讀和驗證 XBRL 和 iXBRL Finance 相關格式。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/finance/headers/aspose_finance-for-python-net.svg" pfName="Aspose.Finance " subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/finance/python-net" >}}
...
<p align="justify"> Aspose.Finance for Python via .NET 是一個用於金融相關格式處理的靈活庫。 API 可以輕鬆創建、讀取和驗證可擴展業務報告語言 XBRL 和 iXBRL 格式以及創建不同格式的 OFX 請求和響應文件。開發人員可以輕鬆開發支持 XBRL 的軟件，也可以在任何現有的數字財務報告系統中使用 XBRL 創建報告。它是一個可擴展、易於使用且獨立於任何其他軟件的獨立 API。</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="通過 .NET API 對 Python 的 Aspose.Finance 進行概述。" >}}
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.Finance for Python 通過 .NET 支持所有主要平台，包括。" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Python 通過 .NET 的 Aspose.Finance 支持與金融相關的格式。" >}}
<div class="diagram1 d2 d1-python">
 <div class="d1-row">
  ...
  <!--/left-->
  <div class="d1-col d1-right">
   <header><i class="fa  fa-mail-forward"> </i> 僅輸出</header>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    高級 Python 通過 .NET Finance 解析 API 功能
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for Python via .NET 支持生成 XBRL 文檔。只需以下幾行代碼即可創建一個新的 XBRL 實例文檔
    </p>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/finance/python-net/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-finance/Aspose.Finance-for-Python-via-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼通過 .NET 為 Python 提供 Aspose.Finance？" tabId="success-stories" >}}
