...
description: XBRL 到 iXBRL Python 轉換的示例代碼。在基於 Python 的應用程序中使用 API 示例代碼將 XBRL 文件批量轉換為 iXBRL。 
url: /zh-hant/python-net/conversion/xbrl-to-ixbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="通過 Python 將 XBRL 轉換為 iXBRL" h2="XBRL 到 iXBRL 的轉換，無需基於 Python 的應用程序中的任何其他軟件。" >}}
...
1. 使用 XbrlDocument 類加載輸入 XBRL 文件。2. 通過選擇 SaveFormat.IXBRL 為輸出文件設置 SaveOptions。
3.通過提供目標文件和相關的SaveOptions作為參數來調用save方法。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="轉換要求" %}}
要繼續進行 XBRL 到 iXBRL 的轉換，請確保您具有以下先決條件。 
