---
title: OFX प्रतिक्रिया फ़ाइल को 1.03 से 2.2 प्रारूप में Python के माध्यम से कनवर्ट करें
...
url: /hi/python-net/conversion/ofx-response/
family: finance
platformtag: python
feature: conversion
...
{{< blocks/products/pf/i18n/feature-page-header h1="OFX प्रतिक्रिया फ़ाइल को 1.03 से 2.2 प्रारूप में Python के माध्यम से कनवर्ट करें" h2="OFX Microsoft Office स्थापित किए बिना 1.03 से 2.2 रूपांतरण के लिए प्रतिक्रिया फ़ाइल।" >}}
...
1. OfxResponseDocument वर्ग का उपयोग करके इनपुट फ़ाइल लोड करें।1. सहेजें विधि में पैरामीटर के रूप में OfxVersionEnum से ofxVersion V2x का उपयोग करें।1. लक्ष्य फ़ाइल और ofxVersion प्रदान करके सेव विधि को कॉल करें।
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="रूपांतरण आवश्यकता" %}}

OFX प्रतिसाद फ़ाइल 1.03 से 2.2 रूपांतरण के लिए आगे बढ़ने के लिए, सुनिश्चित करें कि आपके पास निम्नलिखित पूर्वापेक्षाएँ हैं। 
