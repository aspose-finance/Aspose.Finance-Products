...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for .NET supporta la generazione di XBRL documenti. Con le seguenti poche righe di codice per creare un nuovo documento di istanza XBRL
    </p>
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Finance for .NET?" tabId="success-stories" >}}
