...
description: Codice di esempio per la conversione da XBRL a rapporto html SEC Python. Utilizza API codice di esempio per la conversione di file batch XBRL in report html SEC all'interno di applicazioni basate su Python. 
url: /it/python-net/conversion/xbrl-to-sec-html-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti XBRL in rapporto html SEC tramite Python" h2="Conversione di rapporti da XBRL a SEC html senza bisogno di altro software all\'interno di applicazioni basate su .NET." >}}
...
1. Carica il file di input XBRL utilizzando la classe XbrlDocument.2. Impostare SaveOptionsper il file di output scegliendo SaveFormat.SEC_HTML_REPORT.
...
Per procedere con la conversione del rapporto html da XBRL a SEC, assicurati di disporre dei seguenti prerequisiti. 
