...
<p align="justify"> Aspose.Finance for .NET adalah pustaka fleksibel untuk pemrosesan format yang terkait dengan keuangan. API dapat dengan mudah membuat, membaca, dan memvalidasi format Bahasa Pelaporan Bisnis eXtensible XBRL dan iXBRL serta membuat file Permintaan dan Respons OFX dalam format yang berbeda. Pengembang dapat mengembangkan XBRL perangkat lunak yang diaktifkan dengan mudah atau dapat digunakan dalam sistem pelaporan keuangan digital yang ada untuk membuat laporan dengan XBRL. Ini dapat diperluas, mudah digunakan, dan berdiri sendiri API independen dari perangkat lunak lainnya.</p>
...
{{< blocks/products/pf/carousel-item h3="Sekilas" description="Ikhtisar Aspose.Finance for .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.Finance for .NET mendukung semua platform utama termasuk." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.Finance for .NET mendukung format yang terkait dengan keuangan." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fitur .NET Finance Parsing API Lanjutan
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for .NET mendukung pembuatan XBRL dokumen. Dengan hanya beberapa baris kode berikut untuk membuat XBRL dokumen instans baru
    </p>
    <div class="codeblock" id="code">
     <h3>
      Buat XBRL Instance - C#
     </h3>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/finance/net/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-finance/Aspose.Finance-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.Finance for .NET?" tabId="success-stories" >}}
