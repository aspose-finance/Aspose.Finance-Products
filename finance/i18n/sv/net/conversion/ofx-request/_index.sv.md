---
title: Konvertera OFX Begär fil från 1.03 till 2.2 Format via C#
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera OFX Begär fil från 1.03 till 2.2 Format via C#" h2="OFX Begär fil från 1.03 till 2.2 konvertering utan att behöva Microsoft Office installeras." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hur man konverterar OFX Begär fil från 1.03 till 2.2 Format" %}}
1. Ladda inmatningsfil med användning [OfxRequestDokumentklass](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument).1. Använd av xVersion V2x från från [AvxVersionEnumName](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxversionenum) Som parameter i Spara metoden.1. Ring. [Spara metoden](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument/methods/save) Genom att tillhandahålla målfilen och av xVersion.
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Omvandlingskrav" %}}
För att fortsätta för OFX Be om fil från 1.03 till 2.2 konvertering, är .NET Finance API det viktigaste kravet. 
...
{{% blocks/products/pf/agp/code-block title="C# kod för OFX begär fil från 1.03 till 2.2 format konvertering" offSpacer="" %}}
