---
title: C# .NET Financial Digital Reporting Systems용 API - Aspose 
weight: 20
url: /ko/net/ 
description: C# ASP.NET VB.NET 재무제표를 eXtensible Business Reporting Language XBRL 및 iXBRL로 변환하여 XBRL 분류 및 보고서 생성을 위한 분석용 라이브러리
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET Finance 문서를 구문 분석하는 라이브러리" h2="모든 비즈니스 프로세스 관리, 재무 분석 및 보고 소프트웨어 내에서 XBRL 및 iXBRL Finance 관련 형식을 만들고 읽고 확인합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/finance/headers/aspose_finance-for-net.svg" pfName="Aspose.Finance " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/finance/net" >}}
...
{{< blocks/products/pf/carousel-item h3="한눈에" description="Aspose.Finance for .NET API 개요." >}}
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="Aspose.Finance for .NET은(는) 다음을 포함한 모든 주요 플랫폼을 지원합니다." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Aspose.Finance for .NET은(는) 금융 관련 형식을 지원합니다." >}}
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for .NET은(는) XBRL 문서 생성을 지원합니다. 다음 몇 줄의 코드로 새 XBRL 인스턴스 문서를 생성합니다.
    </p>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/finance/net/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-finance/Aspose.Finance-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="왜 Aspose.Finance for .NET인가요?" tabId="success-stories" >}}
