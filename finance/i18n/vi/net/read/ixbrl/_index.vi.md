---
title: Đọc iXBRL Tệp qua C#
description: Mã mẫu để đọc tệp iXBRL. Sử dụng mã mẫu API để đọc hàng loạt iXBRL tệp trong các ứng dụng dựa trên .NET. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Đọc iXBRL Tệp qua C#" h2="Đọc báo cáo tài chính ở định dạng iXBRL mà không cần cài đặt Microsoft Office hoặc bất kỳ phần mềm nào khác." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/finance/net/read/xbrl/" name="XBRL" description="Ngôn ngữ Báo cáo Kinh doanh Có thể Mở rộng" >}}
