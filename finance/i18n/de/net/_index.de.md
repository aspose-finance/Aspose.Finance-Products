...
<p align="justify"> Aspose.Finance for .NET ist eine flexible Bibliothek für die Verarbeitung finanzbezogener Formate. API kann die eXtensible Business Reporting Language XBRL- und iXBRL-Formate einfach erstellen, lesen und validieren sowie OFX Request- und Response-Dateien in verschiedenen Formaten erstellen. Entwickler können ganz einfach XBRL-fähige Software entwickeln oder innerhalb eines bestehenden digitalen Finanzberichtssystems verwenden, um Berichte mit XBRL zu erstellen. Es ist ein erweiterbares, benutzerfreundliches und eigenständiges API, das von jeder anderen Software unabhängig ist.</p>
...
{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Eine Übersicht über Aspose.Finance for .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.Finance for .NET unterstützt alle wichtigen Plattformen einschließlich." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Finance for .NET unterstützt finanzbezogene Formate." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Erweiterte .NET Finance Parsing-API-Funktionen
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for .NET unterstützt das Generieren von XBRL-Dokumenten. Mit den folgenden wenigen Codezeilen erstellen Sie ein neues XBRL-Instanzdokument
    </p>
    <div class="codeblock" id="code">
     <h3>
      XBRL Instanz erstellen - C#
     </h3>
{{< gist "aspose-com-gists" "45ce5017ccbed6346157615aa7e5a36f" "create-xbrl-instance.cs" >}}
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      iXBRL Instanzdokumente lesen - C#
     </h3>
...
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-finance/Aspose.Finance-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Finance for .NET?" tabId="success-stories" >}}
