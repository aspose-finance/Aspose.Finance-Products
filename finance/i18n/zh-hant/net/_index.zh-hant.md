---
title: C# .NET 用於財務數字報告系統的api- Aspose 
weight: 20
url: /zh-hant/net/ 
description: C# ASP.NET VB.NET 庫,用於將財務報表轉換為可擴展的業務報告語言 XBRL 和 iXBRL 進行分析以生成 XBRL 分類法和報告
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於解析 Finance 文檔的 .NET 庫" h2="在任何業務流程管理,財務分析和報告軟件中創建,讀取和驗證 XBRL 和 iXBRL Finance 相關格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/finance/headers/aspose_finance-for-net.svg" pfName="Aspose.Finance " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/finance/net" >}}
...
<p align="justify"> Aspose.Finance for .NET 是一個靈活的庫,用於財務相關的格式處理。 API 可以輕鬆地創建、讀取和驗證可擴展業務報告語言 XBRL 和 iXBRL 格式,以及創建不同格式的 OFX 請求和響應文件。 開發人員可以輕鬆開發啟用 XBRL 的軟件,或者可以在任何現有的數字財務報告系統中使用 XBRL 創建報告。 它是一個獨立於任何其他軟件的可擴展、易於使用和獨立的 API。</p>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.Finance for .NET 支持所有主要平台,包括。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Finance for .NET 支持與財務相關的格式。" >}}
...
<p class="col-lg-10">DOM Tree manipulation of official SVG specifications</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Finance for .NET 支持生成 XBRL 文檔。 用下面幾行代碼來創建一個新的 XBRL 實例文檔
    </p>
...
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/finance/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼 Aspose.Finance for .NET?" tabId="success-stories" >}}
