---
title: Ubah XBRL menjadi iXBRL melalui Python
description: Kode contoh untuk konversi XBRL ke iXBRL Python. Gunakan API kode contoh untuk file XBRL batch ke konversi iXBRL dalam aplikasi berbasis Python. 
url: /id/python-net/conversion/xbrl-to-ixbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Ubah XBRL menjadi iXBRL melalui Python" h2="XBRL ke iXBRL konversi tanpa memerlukan perangkat lunak lain apa pun dalam aplikasi berbasis Python." >}}
...
1. Muat file XBRL masukan menggunakan kelas XbrlDocument.2. Atur SaveOptions untuk file output dengan memilih SaveFormat.IXBRL.
3. Panggil metode simpan dengan menyediakan file target dan SaveOptions yang relevan sebagai parameter.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Persyaratan Konversi" %}}
Untuk melanjutkan konversi XBRL ke iXBRL, pastikan Anda memiliki prasyarat berikut. 
