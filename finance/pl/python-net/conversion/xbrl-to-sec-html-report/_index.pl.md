...
description: Przykładowy kod konwersji XBRL do SEC html raportu Python. Użyj API przykładowego kodu dla plików wsadowych XBRL do konwersji raportu SEC html w aplikacjach opartych na Python. 
url: /pl/python-net/conversion/xbrl-to-sec-html-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj XBRL na raport SEC html przez Python" h2="Konwersja raportu html z XBRL do SEC bez konieczności używania innego oprogramowania w aplikacjach opartych na .NET." >}}
...
1. Załaduj plik wejściowy XBRL przy użyciu klasy XbrlDocument.2. Ustaw opcję SaveOptions dla pliku wyjściowego, wybierając SaveFormat.SEC_HTML_REPORT.
3. Wywołaj metodę zapisu, podając plik docelowy i odpowiednie opcje SaveOptions jako parametry.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Wymagania dotyczące konwersji" %}}
Aby przejść do konwersji raportu XBRL na SEC html, upewnij się, że spełniasz następujące wymagania wstępne. 
