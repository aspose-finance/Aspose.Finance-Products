---
title: Pythonを介してXBRLをiXBRL（インラインxbrl）に変換します
description: iXBRLからXBRLPythonへの変換のサンプルコード。 Pythonベースのアプリケーション内でのバッチiXBRLファイルからXBRLへの変換にはAPIサンプルコードを使用します。 
url: /ja/python-net/conversion/ixbrl-to-xbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="iXBRL（インラインxbrl）をPython経由でXBRLに変換します" h2="Pythonベースのアプリケーション内で他のソフトウェアを必要とせずにiXBRLからXBRLに変換します。" >}}
...
1. InlineXbrlDocumentクラスを使用して入力インラインXBRLファイルをロードします。2.ターゲットファイルをパラメーターとして指定して、export_to_xbrlメソッドを呼び出します。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="変換要件" %}}
iXBRLからXBRLへの変換を続行するには、次の前提条件があることを確認してください。 
