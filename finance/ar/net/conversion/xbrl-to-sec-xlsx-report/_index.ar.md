...
description: نموذج كود للتحويل من XBRL إلى تقرير xlsx SEC C#. استخدم API رمز المثال لملفات الدُفعات XBRL لتحويل تقرير SEC xlsx ضمن التطبيقات المستندة إلى .NET. 
url: /ar/net/conversion/xbrl-to-sec-xlsx-report/
family: finance
platformtag: net
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل XBRL إلى تقرير SEC xlsx عبر C#" h2="XBRL إلى SEC xlsx تقرير التحويل دون الحاجة إلى أي برامج أخرى داخل التطبيقات المستندة إلى .NET." >}}
...
للمتابعة من أجل تحويل تقرير XBRL إلى SEC xlsx ، فإن .NET Finance API هو المطلب الرئيسي. قم بتثبيته عبر سطر الأوامر باسم `` nuget install Aspose.Finance '' أو عبر Package Manager Console في Visual Studio مع `` Install-Package Aspose.Finance ''.
