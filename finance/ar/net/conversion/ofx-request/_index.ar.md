---
title: تحويل OFX طلب ملف من 1.03 إلى 2.2 تنسيق عبر C#
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل OFX طلب ملف من 1.03 إلى 2.2 تنسيق عبر C#" h2="OFX اطلب ملف من 1.03 إلى 2.2 تحويل دون الحاجة إلى تثبيت Microsoft Office." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل OFX طلب ملف من 1.03 إلى 2.2 تنسيق" %}}
1. تحميل ملف الإدخال باستخدام [فئة OfxRequestDocument](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument).1. استخدم ofxVersion V2x من [OfxVersionEnum](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxversionenum) كمعلمة في طريقة الحفظ.1. اتصل ب [طريقة الحفظ](https://apireference.aspose.com/finance/net/aspose.finance.ofx/ofxrequestdocument/methods/save) من خلال توفير الملف الهدف و ofxVersion.
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات التحويل" %}}
للمتابعة من أجل OFX طلب ملف من 1.03 إلى 2.2 تحويل ، فإن .NET Finance API هو المطلب الرئيسي. 
...
{{% blocks/products/pf/agp/code-block title="C# لـ OFX طلب ملف من 1.03 إلى 2.2 تحويل تنسيق" offSpacer="" %}}
