---
title: قراءة OFX طلب ملف عبر Python
description: نموذج التعليمات البرمجية لـ OFX طلب قراءة ملف. استخدم API مثال التعليمات البرمجية لقراءة ملفات الطلبات المجمعة OFX داخل التطبيقات المستندة إلى Python. 
url: /ar/python-net/read/ofx-request/
family: finance
platformtag: python
feature: read
...
{{< blocks/products/pf/i18n/feature-page-header h1="قراءة OFX طلب الملفات عبر Python" h2="قراءة التقارير المالية بتنسيق طلب OFX دون الحاجة إلى تثبيت Microsoft Office أو أي برامج أخرى." >}}
...
1. إنشاء مثيل فئة OfxRequestDocument.1. قم بتمرير اسم ملف طلب OFX صالح كمعامل.1. للحصول على التفاصيل الداخلية للملف ، استخدم الفئات ذات الصلة مثل SignonRequest
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات القراءة" %}}
لمتابعة قراءة OFX طلب المستندات ، تأكد من أن لديك المتطلبات الأساسية التالية. 
...
{{% blocks/products/pf/agp/code-block title="Python رمز لقراءة OFX طلب الملفات" offSpacer="" %}}
