---
title: إنشاء ملف iXBRL (xbrl مضمّن) عبر Python
description: نموذج التعليمات البرمجية لإنشاء ملف iXBRL (xbrl). استخدم API رمز المثال لإنشاء ملفات الدُفعات iXBRL (inline xbrl) داخل التطبيقات المستندة إلى Python. 
url: /ar/python-net/create/ixbrl/
family: finance
platformtag: python
feature: create
informat: iXBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="إنشاء ملفات iXBRL (xbrl مضمنة) عبر Python" h2="iXBRL إنشاء ملفات (xbrl مضمنة) دون الحاجة إلى تثبيت Microsoft Office أو أي برامج أخرى." >}}
...
1. إنشاء مثيل فئة InlineXbrlDocument.2. بناء عنصر دوم شجرة
3. قم باستدعاء طريقة الحفظ بتوفير مسار الملف الهدف.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات الخلق" %}}
لمتابعة إنشاء مستندات iXBRL (inline xbrl) ، تأكد من أن لديك المتطلبات الأساسية التالية. 
