...
description: Пример кода для преобразования XBRL в отчет SEC xlsx Python. Используйте пример кода API для пакетного преобразования файлов XBRL в отчет SEC xlsx в приложениях на основе Python. 
url: /ru/python-net/conversion/xbrl-to-sec-xlsx-report/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование XBRL в отчет SEC xlsx через Python" h2="Преобразование отчетов XBRL в SEC xlsx без использования какого-либо другого программного обеспечения в приложениях на основе Python." >}}
...
1. Загрузите входной файл XBRL с помощью класса XbrlDocument.2. Задайте SaveOptions для выходного файла, выбрав SaveFormat.SEC_XLSX_REPORT.
...
Чтобы приступить к преобразованию XBRL в отчет SEC xlsx, убедитесь, что выполнены следующие предварительные условия. 
