---
title: Преобразование XBRL в iXBRL(встроенный xbrl) через Python
description: Пример кода для преобразования iXBRL в XBRL Python. Используйте пример кода API для пакетного преобразования iXBRL файлов в XBRL в приложениях на основе Python. 
url: /ru/python-net/conversion/ixbrl-to-xbrl/
family: finance
platformtag: python
feature: convert
informat: XBRL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование iXBRL(встроенный xbrl) в XBRL через Python" h2="Преобразование iXBRL в XBRL без использования какого-либо другого программного обеспечения в приложениях на основе Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Как преобразовать iXBRL в XBRL" %}}
1. Загрузите входной встроенный файл XBRL с помощью класса InlineXbrlDocument.2. Вызовите метод export_to_xbrl, указав целевой файл в качестве параметров.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Требования к конвертации" %}}
Чтобы перейти к преобразованию iXBRL в XBRL, убедитесь, что у вас выполнены следующие предварительные условия. 
...
{{% blocks/products/pf/agp/code-block title="Исходный код C# для преобразования iXBRL в файл XBRL" offSpacer="" %}}
