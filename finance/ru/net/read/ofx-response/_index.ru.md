---
title: Чтение файла ответа OFX через C#
description: Пример кода для чтения файла ответов OFX. Используйте пример кода API для чтения пакетных файлов ответов OFX в приложениях на основе .NET. 
url: /ru/net/read/ofx-response/
family: finance
platformtag: net
feature: read
...
{{< blocks/products/pf/i18n/feature-page-header h1="Прочитать OFX файлов ответов через C#" h2="Чтение финансовых отчетов в формате ответа OFX без установки Microsoft Office или любого другого программного обеспечения." >}}
...
Чтобы перейти к чтению OFX ответных документов, .NET Finance API является основным требованием, которое должно быть включено в приложение. 
...
{{% blocks/products/pf/agp/code-block title="C# код для чтения OFX файлов ответов" offSpacer="" %}}
